...
<html lang="en" dir="ltr">
  ...
  <title>Laravel 10 - Admin Dashboard</title>
  ...
  <body class="sidebar-fixed sidebar-dark header-light header-fixed" id="body">
    ...
    <div class="wrapper">
          ...
          =====================================
        -->
        <!-- здесь подключим наш сацдбар из другого файла -->
      ...
      <div class="page-wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="copyright bg-white">
              <p>
                &copy; <span id="copy-year">2019</span> Copyright Laravel10 Dashboard Bootstrap Template by
                <a
                  class="text-primary"
